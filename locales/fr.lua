local Translations = {
    ...
    success = {
        ...
        being_helped = 'Vous êtes en train d\'être soigné..'
    },
    info = {
        ...
        respawn_revive = 'MAINTENEZ [~r~E~s~] PENDANT ~r~%{holdtime}~s~ SECONDES POUR RÉAPPARAITRE ($~r~%{cost}~s~)',
        bleed_out = 'VOUS ALLEZ VOUS VIDER DE VOTRE SANG DANS : ~r~%{time}~s~ SECONDES',
        bleed_out_help = 'VOUS VOUS VIDEREZ DE VOTRE SANG DANS : ~r~%{time}~s~ SECONDES, VOUS POUVEZ ÊTRE SECOURUS PAR LES EMS',
        ...
        paleto_hospital = 'Hôpital de Paleto',
